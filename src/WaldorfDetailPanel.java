...
public class WaldorfDetailPanel extends JPanel {
    ...
    public WaldorfDetailPanel(ScreenManager manager) {
        ...
        JLabel title = new JLabel("Waldorfstraat");
        ...
        // image
        ImageIcon icon = new ImageIcon("waldorf.jpg");
        JLabel img;
        ...
        JTextArea info = new JTextArea("Information about Waldorfstraat...\n\nAvailable spaces, rules, tips.");
