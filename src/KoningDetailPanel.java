...
public class KoningDetailPanel extends JPanel {
    ...
    public KoningDetailPanel(ScreenManager manager) {
        ...
        JLabel title = new JLabel("Koningstraat");
        ...
        ImageIcon icon = new ImageIcon("koning.jpg");
        JLabel img;
        ...
        JTextArea info = new JTextArea("Information about Koningstraat...\n\nParking restrictions, peak hours, sensors.");
